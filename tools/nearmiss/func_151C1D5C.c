...
void func_151C1D5C(s32 arg0, Vec151C196C *arg1, Vec151C196C *arg2, Ray151C196C *arg3, f32 arg4,
    ...
    *arg11 = 0.0f;
    ...
    do {
        func_15081690(arg0, pos.x, pos.y, pos.z, arg2->x, arg2->y, arg2->z, ray, arg4, arg5,
                      arg6, arg7, arg8, arg9, arg13);
        obj = ray->unk5C;
        dist += ray->unk04;
        if (obj != NULL) {
            if ((obj->unk4F & 0x60) == 0x40) {
                pos.x = ray->unk08.x + ray->unk38.x * 0.1f;
                pos.y = ray->unk08.y + ray->unk38.y * 0.1f;
                pos.z = ray->unk08.z + ray->unk38.z * 0.1f;
                *arg10 = ray->unk08;
                *arg11 = dist;
                dist += 0.1f;
                arg12->unk00 = ray->unk08.y;
                arg12->unk04 = ray->unk44;
                arg12->unk18 = ray->unk60;
                arg12->unk1C = 7;
                arg12->unk1D = 3;
                arg12->unk20 = obj;
                more = 1;
