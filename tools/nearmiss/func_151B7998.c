...
s32 func_151B7998(struct151B7998Arg0 *arg0) {
    f32 maxLen;
    f32 total;
    f32 scale;
    f32 remaining;
            ...
            do {
                ...
                if (maxLen < total) {
                    if (len) {
                        ...
                        frac = (total - maxLen) / len;
                        next = &points[i];
                        dx = next->unk0 - cur->unk0;
                        dy = next->unk4 - cur->unk4;
                        dz = next->unk8 - cur->unk8;
                        next->unk0 = next->unk0 - dx * frac;
                        next->unk4 = next->unk4 - dy * frac;
                        next->unk8 = next->unk8 - dz * frac;
                        cur->unkC = cur->unkC * (1.0f - frac);
                    }
                    total = maxLen;
                    while (i != arg0->unk2D) {
    ...
    if (arg0->unk2C >= 2) {
        ...
        do {
            ...
            cur = &points[j];
            cur->unk10 = remaining * alphaScale;
            remaining -= cur->unkC;
        } while (j != arg0->unk2D);
    }
    return 1;
