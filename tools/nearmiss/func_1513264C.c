...
/*
 * The effect system keeps one shared resource record (EffectRes) per effect id.
 * Records live on a doubly linked list; D_800DC468[id] counts how many live
 * objects reference the record, D_800DC63C is the global live-object count.
 * variables.h types these as plain scalars, hence the casts below.
 */
typedef struct EffectRes {
    s32 *gfx;                   /* 0x00, filled in by func_151336A8 */
    struct EffectRes *next;     /* 0x04 */
    struct EffectRes *prev;     /* 0x08 */
    u16 id;                     /* 0x0C */
    u8 unkE;                    /* 0x0E */
} EffectRes;                    /* 0x10 */

#define gEffectResHead (*(EffectRes **)&D_800DC460)
#define gEffectResTail (*(EffectRes **)&D_800DC464)
#define gEffectResUsers ((s16 *)D_800DC468)

/* Spawn descriptor: copied verbatim into the object at +0x10. */
typedef struct {
    u8 pad_0[0x28];
    f32 posX;                   /* 0x28 */
    f32 posY;                   /* 0x2C */
...
/* Ground/collision info, either supplied by the caller or reset here. */
typedef struct {
    f32 height;                 /* 0x00 */
    u8 pad_4[0x14];
    s32 unk18;                  /* 0x18 */
...
typedef struct {
    u8 pad_0[0x10];
    EffectDesc desc;            /* 0x10 */
    EffectRes *res;             /* 0x8C */
    u8 pad_90[0x80];
    EffectGround ground;        /* 0x110 */
    f32 lastPos[3];             /* 0x134 */
    f32 speed;                  /* 0x140 */
    f32 invSpeed;               /* 0x144 */
    u8 unk148;                  /* 0x148 */
    ...
    s32 unk168;                 /* 0x168 */
    u8 pad_16C[4];
} EffectObj;                    /* 0x170 + caller-requested extra */

extern EffectObj *func_15167A68(s32, s32, s32, s32, s32, s32);
extern void *allocate_memory(s32, s32, s32, s32);
extern void func_15168A9C(void *);
...
EffectObj *func_1513264C(EffectDesc *arg0, s32 arg1, s32 arg2, EffectGround *arg3, s32 arg4, u8 arg5, s32 arg6) {
    EffectObj *obj;
    EffectRes *res;
    s32 i;
    s32 tries;
    ...
    obj = func_15167A68((arg0->flags & 0x4000) ? 0x48 : 0x19, arg6, arg4 + sizeof(EffectObj), 1, arg5,
                        (arg0->flags & 0x400000) ? 2 : 1);
    if (obj == NULL) {
        return NULL;
    }

    if (gEffectResUsers[arg0->id] == 0) {
        res = (EffectRes *)allocate_memory(sizeof(EffectRes), 1, 2, (arg0->flags & 0x400000) ? 2 : 1);
        if (res == NULL) {
            func_15168A9C(obj);
            func_10004074(obj);
            return NULL;
        }
        if (func_151336A8(arg0->id, (s32 **)res, (s32)obj) != 0) {
            res->next = gEffectResHead;
            if (res->next != NULL) {
                res->next->prev = res;
            } else {
                gEffectResTail = res;
            ...
            if (arg0->flags & 0x100000) {
                if ((D_800BE9F0 == 0x3B) || (D_800BE9F0 == 6) || (D_800BE9F0 == 0x13) ||
    ...
    gEffectResUsers[arg0->id]++;
    obj->res = res;
    memcpy(&obj->desc, arg0, sizeof(EffectDesc));
    obj->unk149 = 0;
    obj->lastPos[0] = 0.0f;
    obj->lastPos[1] = 0.0f;
    obj->lastPos[2] = 0.0f;
    obj->speed = sqrtf((arg0->velX * arg0->velX) + (arg0->velY * arg0->velY) + (arg0->velZ * arg0->velZ));
    obj->unk148 = 0;
    obj->invSpeed = 1.0f;
    ...
    if (arg1 != 0) {
        for (i = 0; i <= D_80082FA0; i++) {
            obj->unk154[i] = func_1515D480(arg1);
        }
        obj->unk164 = func_1515D440();
    }

    obj->desc.flags &= 0xFFDFFFFF;
    return obj;
}

s32 func_15132A4C(s32 arg0, s32 arg1, s32 arg2, s32 arg3, u8 arg4, s32 arg5) {
    return (s32)func_1513264C((EffectDesc *)arg0, arg1, arg2, NULL, arg3, arg4, arg5);
}
