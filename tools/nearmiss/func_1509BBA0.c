...
void func_1509BBA0(s32 arg0)
{
  ...
  node = D_800D2F48.unk4;
  func_15096D08();
  if (((D_800BE616 == 0) && (D_800BE9F0 != 0x32)) && (func_1509BE40(0, 0x2000, 0x93) == 0) && (arg0 == 2))
  {
    return;
  }
  func_1509C228();
  ...
  for (i = 0; i < D_800D2F48.length; i++)
  {
    ...
    if (arg0 == 4)
    {
      if (*(u8 *)((tmp >> 3) + (s32) D_800D2E4C) & (1 << (tmp & 7)))
      {
        D_8003C8E0 = 0x6000002;
        func_150ADAF0(node, 4);
        D_8003C8E0 = 0;
        ((u8 *)&D_800D2E70)[tmp] = 3;
        node->unk0 |= 0x8000;
      }
      ...
      if ((*(u8 *)((tmp >> 3) + (s32) D_800D2E4C) & (1 << (tmp & 7))) == 0)
    {
      if (node->unk0 & 0x4000)
      {
        D_8003C8E0 = 0x6000003;
        func_150ADAF0(node, 1);
        D_8003C8E0 = 0;
        node->unk0 &= 0xBFFF;
      }
      if (node->unk0 & 0x8000)
      ...
      if (!(node->unk0 & 0x2000) || (D_800BE9F0 == (*((u16 *) (((u8 *) node) + 2)))))
      {
        if ((arg0 == 2) || ((arg0 == 1) && !(node->unk0 & 0x400)))
        {
          D_8003C8E0 = 0x6000004;
          func_150ADAF0(node, arg0);
          D_8003C8E0 = 0;
        }
        if (arg0 == 2)
        {
