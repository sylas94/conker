...
void func_15115368(struct Obj15115368 *arg0) {
    s32 delay;
    s32 duration;
    f32 elapsed;
    s32 target;
    ...
    if (arg0->unk80 <= delay + duration) {
        if (arg0->unk4F & 4) {
            return;
        }
        arg0->unk80 = delay + duration;
        return;
    }
    if (!(arg0->unk4F & 4)) {
        arg0->unk80 += D_800BE9E4;
    }
    elapsed = (f32)(arg0->unk80 - delay - duration);
    if (arg0->unk84 == 0) {
        angle = elapsed * D_800A2F90;
        s = sinf(angle * 2);
        arg0->unk0 = -3.0f * s;
        s = sinf(angle * 3);
        arg0->unk8 = 2 * s;
        if (elapsed > 10.0f) {
            ...
            arg0->unk12 -= (s8)(arg0->unk3C >> 16) * D_800BE9E4;
            if (((arg0->unk3C & 0xFF) << 4) < (target - arg0->unk12)) {
                arg0->unk84 = 1;
                arg0->unk4F &= ~0x61;
                arg0->unk4F |= 0x20;
            }
        ...
        player = &D_800CC2D0[0];
        dx = player->x_position - (f32)arg0->unk10;
        dz = player->z_position - (f32)arg0->unk14;
        dx = dx * dx;
        dz = dz * dz;
        if ((dx + dz) > D_800A2F94) {
            target = arg0->unk7C;
