...
extern const f32 D_80098918;
extern const f32 D_8009891C;
extern void func_150AD8B0(f32 *arg0, f32 *arg1, f32 *arg2);

void func_1503E5F8(f32 arg0[4][4], f32 *arg1, f32 *arg2, f32 *arg3, f32 *arg4, f32 *arg5, f32 *arg6, f32 *arg7, f32 *arg8, f32 *arg9) {
    f32 mtx[4][4];
    f32 cross[4];
    s32 i;
    f32 len;
    ...
    *arg3 = mtx[3][2];
    ...
    minLen = D_80098918;
    for (i = 0; i < 3; i++) {
        len = func_150AD930(mtx[i]);
        len = (len == 0.0f) ? minLen : len;
        if (i == 0) {
            *arg7 = len;
        } else if (i == 1) {
            *arg8 = len;
        ...
        func_15049148((struct17 *)mtx[i], 1.0f / len, (struct17 *)mtx[i]);
    }

    func_150AD8B0(mtx[1], mtx[2], cross);
    if (func_150AD900(mtx[0], cross) < 0.0f) {
        *arg7 = -*arg7;
        *arg8 = -*arg8;
        *arg9 = -*arg9;
        for (i = 0; i < 3; i++) {
    ...
    rotY = func_150487E0(-mtx[0][2]);
    if (func_150AD780(rotY) != 0.0f) {
        rotX = func_150484A0(mtx[1][2], mtx[2][2]);
        rotZ = func_150484A0(mtx[0][1], mtx[0][0]);
    } else {
        rotX = func_150484A0(mtx[1][0], mtx[1][1]);
        rotZ = 0.0f;
    }

    *arg4 = rotX * D_8009891C;
    *arg5 = rotY * D_8009891C;
    *arg6 = rotZ * D_8009891C;
}
