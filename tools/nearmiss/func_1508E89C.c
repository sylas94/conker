...
void func_15062800(struct127 *);
u16 *func_1509B570(s32);

typedef struct {
    char pad0[0x18];
    /* 0x0018 */ s32 unk18;
    char pad1C[0x9C - 0x1C];
    /* 0x009C */ s32 unk9C[0x40];
    char pad19C[0x39C - 0x19C];
    /* 0x039C */ s32 unk39C[0x10];
    /* 0x03DC */ s32 unk3DC[0x10];
    char pad41C[0xEB0 - 0x41C];
    /* 0x0EB0 */ s32 unkEB0[0x30];
    /* 0x0F70 */ s32 unkF70[0x40];
    char pad1070[0x16C0 - 0x1070];
    /* 0x16C0 */ s32 unk16C0[0x40];
} Struct1508E89C;
...
s32 func_1508E89C(s32 arg0, s32 arg1) {
    ...
    if (((u8 *)&D_800D18A4)[arg0] >= 0x33) {
        if ((D_800D18A2 & (1 << arg0)) == 0) {
            D_800D18A2 |= 1 << arg0;
            D_800D18A0 &= ~(1 << arg0);
            D_800D18A0 |= 1 << arg1;

            func_15085710(arg0, 2, func_150859AC(arg1, 3));
            func_15085710(arg1, 2, 0);

            if (((Struct1508E89C *)D_800D23B0)->unk18 != 0) {
                ((Struct1508E89C *)D_800D23B0)->unk18 &= ~(1 << arg0);
                ((Struct1508E89C *)D_800D23B0)->unk18 |= 1 << arg1;
            }
            if (((Struct1508E89C *)D_800D23B0)->unk9C) {
                ((Struct1508E89C *)D_800D23B0)->unk9C[arg0] = ((Struct1508E89C *)D_800D23B0)->unk9C[arg1];
            }
            if (((Struct1508E89C *)D_800D23B0)->unk39C) {
                ((Struct1508E89C *)D_800D23B0)->unk39C[arg0] = ((Struct1508E89C *)D_800D23B0)->unk39C[arg1];
            }
            if (((Struct1508E89C *)D_800D23B0)->unk3DC) {
                ((Struct1508E89C *)D_800D23B0)->unk3DC[arg0] = ((Struct1508E89C *)D_800D23B0)->unk3DC[arg1];
            }
            if (((Struct1508E89C *)D_800D23B0)->unkEB0) {
                ((Struct1508E89C *)D_800D23B0)->unkEB0[arg0] = ((Struct1508E89C *)D_800D23B0)->unkEB0[arg1];
                if (((Struct1508E89C *)D_800D23B0)->unkEB0[arg0] >= 0) {
                    ((Struct1508E89C *)D_800D23B0)->unkF70[((Struct1508E89C *)D_800D23B0)->unkEB0[arg0]] = arg0;
                }
            }
            ((Struct1508E89C *)D_800D23B0)->unk16C0[arg0] = ((Struct1508E89C *)D_800D23B0)->unk16C0[arg1];

            obj = &D_800CC2D0[arg0];
            savedAnim = obj->unk31C->unk1AA;
            other = &D_800CC2D0[arg1];
            func_15062800(other);

            if (D_800BE9F0 == 0x3F) {
                if (obj->unk13C >= 0x64) {
                    idx = obj->unk13C - 0x64;
                    p = func_1509B570(D_800D2E48);
                    if (p != 0) {
                        objIndex = obj - D_800CC2D0;
                        slot = D_800CC2D0[idx].unique_id - 0x14;
                        *(s32 *)((u8 *)p + slot * 4 + 0x24B8) = objIndex | 0x2000;
                        *(s32 *)((u8 *)p + slot * 4 + 0x24DC) = objIndex;
                    }
                }
            }
            ...
            obj->unk31C->unk84 = 0;
            obj->immune = 0x5A;
            obj->unk31C->unk1AA = savedAnim;
            *(u8 *)((u8 *)obj->unk31C + 0x1AF) = 0x40;
            func_15128774(obj->camera, obj);
            (*(s8 *)&D_8008FD94)++;
        }
    }
    return 0;
