...
struct s1517CFC4_a { s32 unk0; s32 unk4; s32 unk8; u8 unkC; u8 unkD; u8 unkE; u8 unkF; };
...
extern void func_1517BBAC(s32, s32, s32, s32, f32, s32, s32, s32);
...
void func_1517DE5C(void) {
    ...
    if (D_800DDD20 != 0) {
        p = (struct s1517CFC4_a *)&D_800DDA90;
        do {
            p->unkC = 0;
            p++;
        } while (p < (struct s1517CFC4_a *)&D_800DDB80);

        func_1517BBAC((s32)D_800CC2D0[0].x_position, (s32)D_800CC2D0[0].y_position, (s32)D_800CC2D0[0].z_position, 0x5DC,
                      D_800DBFF0->unk380, (s32)D_800DBFF0->unk2F8, (s32)D_800DBFF0->unk2FC, (s32)D_800DBFF0->unk300);
